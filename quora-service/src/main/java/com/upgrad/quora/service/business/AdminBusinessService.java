...
public class AdminBusinessService {
    ...
    public UserAuthEntity getloggedinUserDetailsForDeleteQuestion(String userId, String token)
    ...
    public UserAuthEntity getloggedinUserDetailsForEditQuestion(String userId, String token)
            throws AuthorizationFailedException {
        UserAuthEntity userAuthDetails = userDao.getUserAuthDetails(userId, token);
        if (userAuthDetails == null) {
            throw new AuthorizationFailedException("ATHR-002", "User is signed out");
    ...
    public UserAuthEntity getloggedinUserDetailsForDeleteAnswer(String userId, String token)
            throws AuthorizationFailedException {
        UserAuthEntity userAuthDetails = userDao.getUserAuthDetails(userId, token);
        if (userAuthDetails == null) {
            throw new AuthorizationFailedException("ATHR-002", "User is signed out");
    ...
    public UserAuthEntity getloggedinUserDetailsForEditAnswer(String userId, String token)
            throws AuthorizationFailedException {
        UserAuthEntity userAuthDetails = userDao.getUserAuthDetails(userId, token);
        if (userAuthDetails == null) {
            throw new AuthorizationFailedException("ATHR-002", "User is signed out");
